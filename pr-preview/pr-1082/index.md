...
* Run `java -jar fgbio-2.5.22-e91f611-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-2.5.22-e91f611-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
