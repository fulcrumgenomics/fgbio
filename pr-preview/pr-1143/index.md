...
* Run `java -jar fgbio-3.1.2-d540c9c-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.2-d540c9c-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
