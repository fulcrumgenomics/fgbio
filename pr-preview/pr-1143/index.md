...
* Run `java -jar fgbio-3.1.2-ed4f04c-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.2-ed4f04c-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
