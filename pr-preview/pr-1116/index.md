...
* Run `java -jar fgbio-3.1.1-e7f4f17-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.1-e7f4f17-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
