...
* Run `java -jar fgbio-3.1.1-389280f-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.1-389280f-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
