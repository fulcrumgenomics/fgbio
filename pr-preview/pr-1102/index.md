...
* Run `java -jar fgbio-3.1.0-c798eea-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.0-c798eea-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
