...
* Run `java -jar fgbio-4.0.1-de8e5d4-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-4.0.1-de8e5d4-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
