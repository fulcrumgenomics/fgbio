...
* Run `java -jar fgbio-3.1.0-c88750a-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.0-c88750a-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
