...
* Run `java -jar fgbio-2.6.0-1aa11c4-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-2.6.0-1aa11c4-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
