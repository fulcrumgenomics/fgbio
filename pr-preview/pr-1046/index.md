...
* Run `java -jar fgbio-2.6.0-ca774ec-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-2.6.0-ca774ec-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
