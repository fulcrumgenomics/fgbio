...
* Run `java -jar fgbio-2.5.22-0bba26d-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-2.5.22-0bba26d-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
