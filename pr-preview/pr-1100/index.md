...
* Run `java -jar fgbio-3.1.0-66314de-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.0-66314de-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
