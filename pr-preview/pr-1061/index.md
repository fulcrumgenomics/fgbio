...
* Run `java -jar fgbio-2.5.22-3bb3adf-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-2.5.22-3bb3adf-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
