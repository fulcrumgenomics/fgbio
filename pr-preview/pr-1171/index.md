...
* Run `java -jar fgbio-4.1.2-3be32d7-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-4.1.2-3be32d7-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
