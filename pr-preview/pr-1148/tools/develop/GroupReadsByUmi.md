...
|min-umi-length|l|Int|The minimum UMI length. Discard reads with UMIs shorter than this length.|Optional|1||
|truncate|r|Boolean|Whether to shorten all UMIs above `--min-umi-length` to the specified minimum length.|Optional|1|false|
