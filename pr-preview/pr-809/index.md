...
* Run `java -jar fgbio-3.1.0-6df95eb-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.0-6df95eb-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
