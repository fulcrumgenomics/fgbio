...
* Run `java -jar fgbio-3.1.3-8a8d6ae-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.3-8a8d6ae-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
