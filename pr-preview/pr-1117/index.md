...
* Run `java -jar fgbio-3.1.1-c923d97-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.1-c923d97-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
