...
* Run `java -jar fgbio-3.1.1-b2f3dbe-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.1-b2f3dbe-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
