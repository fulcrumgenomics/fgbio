...
* Run `java -jar fgbio-3.1.0-28610db-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.0-28610db-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
