package com.fulcrumgenomics.utils;

import com.fulcrumgenomics.util.GraphUtils;
...
public class GraphUtilsTest {
    ...
    public void simpleTest() {
        ...
        Stream.of(5, 6, 7, 8, 9).forEach(i -> assertEquals(clusters.get(i), fivesCluster));

        Integer foursCluster = clusters.get(4);
        Stream.of(1, 2, 3, 4).forEach(i -> assertEquals(clusters.get(i), foursCluster));
    ...
    public void secondTest() {
        ...
        Stream.of(8).forEach(i -> assertEquals(clusters.get(i), eightsCluster));
