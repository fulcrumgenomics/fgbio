...
* Run `java -jar fgbio-3.1.3-6aad37c-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.3-6aad37c-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
