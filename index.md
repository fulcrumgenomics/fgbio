...
* Run `java -jar fgbio-2.5.22-1f3a6a6-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-2.5.22-1f3a6a6-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
