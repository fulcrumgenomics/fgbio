...
* Run `java -jar fgbio-2.5.19-3c0dccf-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-2.5.19-3c0dccf-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
