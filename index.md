...
* Run `java -jar fgbio-3.1.1-c8fbd2b-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.1-c8fbd2b-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
