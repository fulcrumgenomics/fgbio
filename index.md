...
* Run `java -jar fgbio-2.5.21-71fe2ab-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-2.5.21-71fe2ab-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
