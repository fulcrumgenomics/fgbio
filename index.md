...
* Run `java -jar fgbio-3.1.0-48d754b-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-3.1.0-48d754b-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
