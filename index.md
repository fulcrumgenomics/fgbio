...
* Run `java -jar fgbio-4.0.1-4cc4d8a-SNAPSHOT.jar` to get a list of available tools
* Run `java -jar fgbio-4.0.1-4cc4d8a-SNAPSHOT.jar <Tool Name>` to see detailed usage instructions on any tool
